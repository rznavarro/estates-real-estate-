...
export default function VideoTour() {
  return (
    <section id="cinema-tour" className="py-16 bg-[#faf8f5] border-b border-[#e8dcd0]/50">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <motion.div 
          ...
          className="relative bg-black rounded-lg border border-[#e8dcd0] shadow-2xl overflow-hidden aspect-video w-full max-w-5xl mx-auto"
        >
          {/* Decorative cinematic frame overlay lines */}
          <div className="absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-transparent via-[#a5897e]/40 to-transparent z-10"></div>
        ...
        {/* Bottom micro-info */}
        <div className="mt-4 flex items-center justify-center space-x-2 text-stone-500 font-sans text-[11px] uppercase tracking-wider">
